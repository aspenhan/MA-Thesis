...
current set, total number of sets completed, and total actual mistakes
made. Scoring was at the set level instead of the slider level so that
the metrics had smaller quantities and could be more easily processed by
subjects while they worked on the task.

\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{survey-screenshots/slider-task-set-example.png}}

}

\caption{\label{fig-task-screenshot}Example of a set in the slider task}
